	...
	<div class="main">
		<div class="help">
			<div class="help_service">
				<div class="help_service_title">
					<h3>고객센터를 통해 궁금증을 해결하세요.</h3>
				</div>
				<div>
					<ul>
						<li class="help_service_list">
							<a href="#"> 
								<img src="/project/resources/image/help/member_img.png" alt="회원정보">
								<span class="help_service_list_text">회원정보</span>
							</a>
						</li>
						<li class="help_service_list">
							<a href="#">
