...
<body>
	<form id="target" role="form" method="post">
		<input type="hidden" name="scNum" value="${dto.scNum }"> <input
			type="hidden" name="userNum" value="${dto.userNum}"> 날짜 : <input
			type="date" name="day"
			value='<fmt:formatDate value="${dto.day}" pattern="yyyy-MM-dd" />'>
		<br> 할 일 : <input type="text" name="schedule"
			value="${dto.schedule }"> <br>
